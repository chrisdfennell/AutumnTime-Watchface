<!-- Thanks for contributing to Autumn! -->
...
- [ ] Bug fix
- [ ] New feature (new indicator, ornamentation, scenery behavior, etc.)
...
<!-- Autumn targets the tactix 8 (Fenix 8 AMOLED). Please cover both case sizes. -->
...
- [ ] Complications fill correctly from live data, and degrade gracefully when a value is
      unavailable (e.g. Body Battery hidden when unsupported)
