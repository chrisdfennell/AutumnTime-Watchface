...
if ($Export) {
    Write-Host "Package Succeeded! Output: bin\Autumn.iq" -ForegroundColor Green
} else {
    Write-Host "Build Succeeded! Output: bin\Autumn.prg" -ForegroundColor Green
}
